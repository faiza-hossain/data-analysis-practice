...
print(planes["Additional_Info"].value_counts()) #frequency 0f values
...
##create and analyze categorical data
...
# Without ^, a pattern like "0h" would also match inside "10h" (because "0h" appears at the end of "10h").

# With ^0h, it only matches if the string begins with "0h", so "10h" is safely excluded.
...
plt.show()
## Adding descriptive summary statistics
...
##CORRELATION
print(divorce.corr(numeric_only=True))#set to true to prevent errors with non
#numeric columns
#heatmap
...
##CONSIDERATIONS & CATEGORICAL DATAS
#class imbalance
# Print the relative frequency of Job_Category
print(salaries['Job_Category'].value_counts(normalize=True))

#cross tabulation
# Perform cross-tabulation, setting "Company_Size" as the index, 
# and the columns to classes in "Experience".
